...
Partial Class BlockExp
    ...
    Private Sub InitializeComponent()
        ...
        Me.MephTheme1.SubHeader = "$BlockExp CHARACTERNAME DURATION REASON"
        Me.MephTheme1.TabIndex = 0
        Me.MephTheme1.Text = "BlockEXP"
        '
        'MephButton1
        '
